...
import { 
  Shield, AlertTriangle, Zap, Activity, Globe, Eye, Search, Filter, 
  Play, Pause, RotateCcw, Download, Bell, Settings, Wifi, WifiOff,
  Server, Database, Lock, Unlock, Target, Crosshair, MapPin, Clock,
  TrendingUp, TrendingDown, CheckCircle, XCircle, AlertCircle,
  Radio, Satellite, Radar, Brain, Cpu, HardDrive, Network
} from 'lucide-react';
