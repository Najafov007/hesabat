...
const SUSPICIOUS_EXTENSIONS = ['.exe', '.scr', '.bat', '.cmd', '.pif', '.com', '.jar', '.vbs', '.js'];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      ...
      >
        ...
        <p>Created by <strong>Nijat Najafov, Huseynli Murad, Elmin</strong> - Azerbaijan Technical University</p>
